...
class AltcoinNews extends Component {
  constructor(){
    super();
    this.state = {
      data: [],
  ...
  fetchData(){
    axios.get(`http://www.newsbtc.com/wp-json/wp/v2/posts/?categories=3&per_page=30&page=1&_embed`)
      .then((res) => {
...
export default connect(mapStateToProps, { goDetailNews, backNews, likedPost, disLikesPost, likedDetailNews, fetchData2 })(AltcoinNews);
